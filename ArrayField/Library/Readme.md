# × ArrayField Library ×
This documentation is for [ArrayField](https://github.com/Aviiela/Library/blob/main/ArrayField/Library/Readme.md) Library.
...
```lua
local Rayfield = loadstring(game:HttpGet('https://raw.githubusercontent.com/Aviiela/Library/main/ArrayField/Library/Source.lua'))()
```
